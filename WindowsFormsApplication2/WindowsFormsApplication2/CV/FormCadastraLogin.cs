...
namespace HouseManager
{
    public partial class FormCadastraLogin : Form
    {
        ...
        private bool IsComplete()
        {
            ...
            if (txtCPF.Text.Trim() == "" || txtNome.Text.Trim() == "" || txtEmail.Text.Trim() == "" || txtTelefone.Text.Trim() == "" || txtTelefone.Text.Trim().Length != 11 || txtUser.Text.Trim() == "" || txtSenha.Text.Trim() == "" || !(System.Text.RegularExpressions.Regex.IsMatch(txtEmail.Text, @"^[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})$")))
            {
